...
import { ChatMessage, ChatThread, DisciplineCase, LearningResource, MarkComment, Student, StudentMark } from '@/types/database'
...
export default function StudentDashboardPage() {
  ...
  const loadData = async () => {
    setLoading(true)
    try {
      const [classes, classStudents, students, resources, marks, comments, threads, messages, disciplineCases, accessProfiles] =
        await Promise.all([
          getClasses(),
          getClassStudents(),
          getStudents(),
